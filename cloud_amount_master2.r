...
png("/home/jim/Dropbox/Python/cloud_amount/RH vs cloud amount.png")
plot(density(data_train[data_train$Cover == "OVC", ]$RELH), col = "black", xlim = c(0, 100), ylim = c(0, 0.2), 
  main = "RH v.s. cloud amount (FEW, SCT, BKN, OVC)",
  xlab = "RH",
  ylab = "Density")
...
tapply(data_train$RELH, data_train$Cover, summary)
